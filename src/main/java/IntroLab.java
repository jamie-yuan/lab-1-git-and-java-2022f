...
public class IntroLab {
     ...
     */
    public static String yuanjami() {
        return printLabMessage("Hi", "Jamie", true,
                "How are you?");
    }
    ...
    public static void main(final String[] args) {
         ...
         */
        System.out.println(yuanjami());


    }

    // Go to test/java/IntroLabTest.java afterwards and complete the TODO.
